...
class PaymentPro
{
    ...
    public function executePayment($amount, $id, $name, $lastName, $contact , $modePay, $ref)
    {
        ...
        $marchanID  = 'PP-F109';
        $notifUrl   = 'http://sapeurdebaby.piecesivoire.com/start-command'; // http://sapeurdebaby.piecesivoire.com/start-command
        $returnUrl  = 'http://sapeurdebaby.piecesivoire.com/congratulation'; // http://sapeurdebaby.piecesivoire.com//congratulation
